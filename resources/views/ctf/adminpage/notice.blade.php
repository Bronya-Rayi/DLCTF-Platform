                                ...
                                <form class="am-form">
                                    <table class="am-table am-table-striped am-table-hover table-main">
                                        ...
                                        @foreach($notice as $noticedata)
                                            <tr>
                                                <td>{{$noticedata -> id}}</td>
                                                <td>{{base64_decode($noticedata -> notice_data)}}</td>
                                                <td class="am-hide-sm-only">{{$noticedata -> add_time}}</td>
                                                <td>
                                                    <div class="am-btn-toolbar">
                                                        <div class="am-btn-group am-btn-group-xs">
                                                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><a href="/ctfadmin/notice/edit/{{$noticedata->id}}"><span class="am-icon-pencil-square-o"></span> 编辑</a></button>
                                                            <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><a href="/ctfadmin/notice/delete/{{$noticedata->id}}"><span class="am-icon-trash-o"></span> 删除</a></button>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="tpl-block">
                        <div class="am-g">
                            <div class="tpl-form-body tpl-form-line">
                                <form action="/ctfadmin/notice" class="am-form tpl-form-line-form" method="POST">
