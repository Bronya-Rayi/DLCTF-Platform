                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-title">Student_id</th>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                        <td>{{$teamdata -> id}}</td>
                                        <td>{{$teamdata -> student_id}}</td>
                                        <td>{{$teamdata -> name}}</td>
                                        <td>{{$teamdata -> task_id}}</a></td>
                                        <td>{{$teamdata -> score}}</td>
                                        <td class="am-hide-sm-only">{{$teamdata -> add_time}}</td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><a href="/ctfadmin/team/edit/{{$teamdata->student_id}}"><span class="am-icon-pencil-square-o"></span> 编辑</a></button>
                                                    </div>
                                            </div>
                                        </td>
                                        </tr>
