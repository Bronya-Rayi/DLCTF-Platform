                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tbody>
                                        ...
                                        <td><a href="#">{{$taskdata -> type_task}}</a></td>
                                        <td>{{$taskdata -> score}}</td>
                                        <td class="am-hide-sm-only">{{$taskdata -> add_time}}</td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><a href="/ctfadmin/task/edit/{{$taskdata->id}}"><span class="am-icon-pencil-square-o"></span> 编辑</a></button>
                                                    <?php if($taskdata->is_hide == 'true'){
                                                    ...
                                                    }else{echo '<button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><a href="/ctfadmin/task/hide/'.$taskdata->id.'"><span class="am-icon-copy"></span>显示中<font color=green>👁</font></a></button>';}?>
                                                    <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><a href="/ctfadmin/task/delete/{{$taskdata->id}}"><span class="am-icon-trash-o"></span>删除</a></button>
                                                    </div>
                                                </div>
                                        </td>
                                        </tr>
