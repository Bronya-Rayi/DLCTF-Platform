        ...
        <div class="tpl-portlet-components">
          <div class="portlet-title">
            <div class="caption font-green bold">
              <span class="am-icon-code"></span>题目添加</div>
          </div>
          <div class="tpl-block">
            <div class="am-g">
              <div class="tpl-form-body tpl-form-line">
                <form action="/ctfadmin/task/add" class="am-form tpl-form-line-form" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">题目名称
                      <span class="tpl-form-line-small-title">task_name</span></label>
                    <div class="am-u-sm-9">
                      <input type="text" class="tpl-form-input" name="task_name" placeholder="请输入标题文字"></div>
                  </div>
                  <div class="am-form-group">
                    <label for="user-phone" class="am-u-sm-3 am-form-label">题目分类
                      <span class="tpl-form-line-small-title">task_type</span></label>
                    <div class="am-u-sm-9">
                  ...
                  <div class="am-form-group">
                    <label class="am-u-sm-3 am-form-label">题目分值
                      <span class="tpl-form-line-small-title">task_score</span></label>
                    <div class="am-u-sm-9">
                      <input type="text" name="score" placeholder="1000"></div>
                  </div>
                  <div class="am-form-group">
                    <label class="am-u-sm-3 am-form-label">题目flag
                      <span class="tpl-form-line-small-title">task_flag</span></label>
                    <div class="am-u-sm-9">
                      <input type="text" name="flag" placeholder="flag{10000}"></div>
                  </div>
                  <div class="am-form-group">
                    <label for="user-intro" class="am-u-sm-3 am-form-label">题目描述</label>
                    <div class="am-u-sm-9">
                      <textarea class="" rows="10" name="task_data" placeholder="请输入题目内容"></textarea>
                    </div>
                  </div>
                  <div class="am-form-group">
