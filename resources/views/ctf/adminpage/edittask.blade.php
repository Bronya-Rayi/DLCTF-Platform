              ...
              <div class="tpl-form-body tpl-form-line">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <input type="text" class="tpl-form-input" name="task_name" value="{{$taskdata -> task_name}}"></div>
                  </div>
                  <div class="am-form-group">
                  ...
                  <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <textarea class="" rows="10" name="taskdata"><?php echo base64_decode($taskdata -> task_data);?></textarea>
                    </div>
                  </div>
                  <div class="am-form-group">
