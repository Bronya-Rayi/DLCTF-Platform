...
@foreach($notice as $noticedata)
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            <div class="tpl-content-page-title">Update Notice</div>
                ...
                <div class="tpl-portlet-components">
                    <div class="portlet-title">
                        <div class="caption font-green bold">
                            <span class="am-icon-code"></span>Notice更新</div>
                    </div>
                    <div class="tpl-block">
                        <div class="am-g">
                            <div class="tpl-form-body tpl-form-line">
                                <form action="" class="am-form tpl-form-line-form" method="POST">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-intro" class="am-u-sm-3 am-form-label">Notice</label>
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" name="noticedata"><?php echo base64_decode($noticedata -> notice_data);?></textarea>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            <button type="submit" class="am-btn am-btn-primary tpl-btn-bg-color-success ">更新</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
